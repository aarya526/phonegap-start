...
var app = {
    ...
    bindEvents: function() {
        ...
        document.getElementById('btnCaculate').addEventListener('click',this.onCalculate, false);
    },
...
document.getElementById('res').innerHTML = "ERROR: please enetr valid values.";
else {
var x=parseInt(b);
var y=parseInt(h);
var area =x*y;
